...
struct MCTSParameters: AgentParameters {
  public:
   ...
   bool continuePreviousSearch = true;  // Indicates if tree should be kept between two consecutive
...
struct convert< SGA::MCTSParameters > {
   /// <summary>
   /// Reads Agent generic (via call rhs.decode(node)) and MCTS-specific parameters received in a
