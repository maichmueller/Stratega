...
/// </summary>
enum class Budget { TIME, ITERATIONS, FMCALLS, UNDEFINED };
...
struct AgentParameters {
  public:
   /// <summary>
   /// The script the opponent is simulated with. Never set this to be a nullptr, use SkipTurnScript
   /// instead
   /// </summary>
   ...
   /// <summary>
   /// Maximum number of iterations for a decision making round. Applies when this->budgetType ==
   /// ITERATIONS;
   /// </summary>
