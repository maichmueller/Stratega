...
class Arena: public SGA::GameObserver {
  public:
   ...
   void onGameStateAdvanced(
      const SGA::GameState& state, const SGA::ForwardModel& forwardModel) override;
   void onGameFinished(
      const SGA::GameState& finalState, const SGA::ForwardModel& forwardModel) override;
