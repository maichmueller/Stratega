...
struct ActionsSettings {
   ...
   bool hasActionTypeSelected() const { return actionTypeSelected != -1; }

   bool hasEntitiesSelected() const { return ! selectedEntities.empty(); }

   bool isSelected(int unitID) { return selectedEntities.find(unitID) != selectedEntities.end(); }
};
