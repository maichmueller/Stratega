...
class Timer {
  ...
  public:
   ...
   Timer(long maxTimeMs_ = 0) : maxTimeMs(maxTimeMs_) { start(); }
   ...
   /// <summary>
   double elapsedSeconds() const { return static_cast< double >(elapsedMilliseconds()) / 1000.0; }

   /// <summary>
   // Returns the elapsed time in minutes.
   /// <summary>
   double elapsedMinutes() const { return elapsedSeconds() / 60.0; }

   /// <summary>
   // Returns the elapsed time in hours.
   /// <summary>
   double elapsedHours() const { return elapsedMinutes() / 60.0; }

   /// <summary>
   // Set the max time
   /// <summary>
   /// <param name="time">Max timer in milliseconds.</param>
   void setMaxTimeMilliseconds(long newMaxTimeMs) { maxTimeMs = newMaxTimeMs; }
   ...
   /// <summary>
   bool exceededMaxTime() const { return elapsedMilliseconds() > maxTimeMs; }

   /// <summary>
   // Checks if the elapsed time exceeded max time.
   /// <summary>
   long getMaxTimeMilliseconds() const { return maxTimeMs; }

   /// <summary>
   /// Returns the proportion of time completed of this timer.
   /// </summary>
   /// <returns>A proportion of the time completed. 0.0 means timer just started, while 1.0 means
   /// time is exactly complete. </returns>
   double percCompletedTime() const { return double(elapsedMilliseconds()) / double(maxTimeMs); }
};
}  // namespace SGA