...
/// <typeparam name="BaseType">The type of the elements that should be contained in the returned
/// vector.</typeparam> <typeparam name="ValueType">Deducted automatically. The type currently
/// contained in the container.</typeparam>
template <
   typename Iterator,
   typename BaseType,
