...
struct GameInfo {
  private:
   ...
   /// <summary>
   /// Relation of entity types in the Entity Groups of this game: name (of entity group) ->
   /// set<entity type id>
   /// </summary>
  ...
  public:
   ...
   /// <summary>
   /// Returns a technology node with an ID corresponding to the one passed by parameter. The node
   /// could come from any of the trees of the tree collection.
   /// </summary>
   ...
   /// <summary>
   /// Returns the ID of a technology that matches the requested name, in any of the trees of the
   /// tree collection.
   /// </summary>
   ...
   void setParameterIDLookup(std::shared_ptr< std::unordered_map< std::string, ParameterID > > pID)
   {
      parameterIDLookup = pID;
   }
   void setPlayerParameterTypes(std::shared_ptr< std::unordered_map< ParameterID, Parameter > > pt)
   {
      playerParameterTypes = pt;
   }
   void setPlayerSpawnableTypes(std::shared_ptr< std::unordered_set< EntityTypeID > > pt)
   {
      playerSpawnableTypes = pt;
   }
   void setEntityTypes(std::shared_ptr< std::unordered_map< int, EntityType > > et)
   {
      entityTypes = et;
   }
   void setActionTypes(std::shared_ptr< std::unordered_map< int, ActionType > > at)
   {
      actionTypes = at;
   }
   void setTileTypes(std::shared_ptr< std::unordered_map< int, TileType > > tt) { tileTypes = tt; }
   void setTechnologyTreeCollection(std::shared_ptr< TechnologyTreeCollection > tt)
   {
      technologyTreeCollection = tt;
   }
   void setEntityGroups(std::unordered_map< std::string, std::unordered_set< EntityTypeID > > eg)
   {
      entityGroups = eg;
   }
   ...
   const std::unordered_map< std::string, ParameterID >& getParameterIDLookup() const
   {
      return *parameterIDLookup;
   }
   const std::unordered_map< ParameterID, Parameter >& getPlayerParameterTypes() const
   {
      return *playerParameterTypes;
   }
   const std::unordered_set< EntityTypeID >& getPlayerSpawnableTypes() const
   {
      return *playerSpawnableTypes;
   }
   ...
   const TechnologyTreeCollection& getTechnologyTreeCollection() const
   {
      return *technologyTreeCollection;
   }
   const std::unordered_map< std::string, std::unordered_set< EntityTypeID > >& getEntityGroups()
      const
   {
      return entityGroups;
   }
