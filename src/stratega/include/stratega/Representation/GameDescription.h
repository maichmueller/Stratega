...
struct GameDescription {
  ...
  public:
   GameDescription(
      std::unordered_map< ActionCategory, std::vector< int > > actionCat,
      std::unordered_map< EntityCategory, std::vector< int > > entityCat)
       : actionCategories(actionCat), entityCategories(entityCat)
   {
   }
   ...
   /// </summary>
   const std::unordered_map< ActionCategory, std::vector< int > >& getActionCategories() const
   {
   ...
   /// </summary>
   const std::unordered_map< EntityCategory, std::vector< int > >& getEntityCategories() const
   {
   ...
   std::vector< ActionType > getActionTypes(
      ActionCategory category, const GameInfo& gameInfo) const;
   ...
   std::vector< EntityType > getEntityTypes(
      EntityCategory category, const GameInfo& gameInfo) const;

   /// <summary>
   /// Checks if a given entity type ID belongs to a given category
   /// </summary>
   /// <param name="category">The category group to be cheked.</param>
   /// <param name="entityTypeId">ID Type of the entity that is to be checekd if it's part of the
   /// category.</param> <returns>True if entityTypeId is a subset of the category given</returns>
