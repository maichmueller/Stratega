...
/// definitions, the actions that can execute, required technologies to spawn a entity, a list of
/// spawnable entity types and a list of cost assigned to this entity type.
/// </summary>
struct EntityType {
  private:
   /// <summary>
   ...
   /// <summary>
   /// ID of the technology that needs to be researched so this entity can be spawned/built/created
   /// in the game.
   /// </summary>
   ...
   /// <summary>
   /// Map of parameters of this entity. Key is an integer (ID of the parameter) and value is the
   /// paramter object. The parameter defines the min, max and default value this parameter can
   /// take.
   /// </summary>
  ...
  public:
   ...
   const std::unordered_set< EntityTypeID >& getSpawnableEntityTypes() const
   {
      return spawnableEntityTypes;
   }
   void setSpawnableEntityTypes(const std::unordered_set< EntityTypeID >& set)
   {
      spawnableEntityTypes = set;
   }
