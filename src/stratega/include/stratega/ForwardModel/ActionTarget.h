...
/// <summary>
/// Used by <see cref="SGA::Action"/> to reference any possible type of target available in
/// Stratega. It contains a union of different types of data.
/// </summary>
class ActionTarget {
  public:
   enum Type {
   ...
   int getTechnologyID() const { return m_data.technologyID; }
   int getPlayerID() const;
   int getPlayerID(const GameState& state) const;
   int getEntityID() const { return m_data.entityID; }
   int getContinuousActionID() const { return m_data.continuousActionID; }
   Type getType() const { return m_targetType; }
   std::string getTypeString() const
   {
      switch(m_targetType) {
         case EntityReference: return "EntityReference"; break;
         case Position: return "Position"; break;
         case PlayerReference: return "PlayerReference"; break;
         case EntityTypeReference: return "EntityTypeReference"; break;
         case TechnologyReference: return "TechnologyReference"; break;
         case ContinuousActionReference: return "ContinuousActionReference"; break;
         case TileTypeReference: return "TileTypeReference"; break;
         default: return "Not defined";
      }
   }
   std::string getValueString(const GameState& state) const;
   // Check if this action target is valid in the received gamestate
   static bool isValidWithTargets(
  ...
  private:
   ...
   ActionTarget(const Type& type, const Data& data) : m_targetType(type), m_data(data){};
};
