...
/// The <see cref="SGA::TBSForwardModel::advanceGameState()"/> accepts a list of actions or one
/// single action.
/// </summary>
class TBSForwardModel: public ForwardModel {
  public:
   ...
   /// <summary>
   /// End the turn of the current player and if all the player has played it ends the current game
   /// turn.
   /// </summary>
