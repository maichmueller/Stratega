...
enum class ShapeType { Circle, Square, Cross, Line, AllPositions };
  ...
  public:
   ...
   const std::string getTypeString() const
   {
      switch(type) {
         ...
         case EntityType: return "EntityType"; break;
         case Entity: return "Entity"; break;
         case Technology: return "Technology"; break;
         case ContinuousAction: return "ContinuousAction"; break;
      }
   }
   ...
   bool isValid(
      ...
      const ActionTarget& sourceActionTarget) const;
   ...
   void setSamplingMethod(std::shared_ptr< SamplingMethod > newSamplingMethod)
   {
      this->samplingMethod = newSamplingMethod;
   }

   const std::unordered_set< int >& getGroupEntityTypes() const { return groupEntityTypes; }
   void setGroupEntityTypes(const std::unordered_set< int >& groupTypes)
   {
      groupEntityTypes = groupTypes;
   }
