...
class GameObserver {
  public:
   ...
   virtual void onGameStarted(
      const GameState& /*initialState*/, const ForwardModel& /*forwardModel*/){};
   /// <summary>
   ...
   virtual void onGameStateAdvanced(
      const GameState& /*state*/, const ForwardModel& /*forwardModel*/){};
   /// <summary>
   ...
   virtual void onGameFinished(
      const GameState& /*finalState*/, const ForwardModel& /*forwardModel*/){};
};
}  // namespace SGA